...
{else}
  ...
  <div class="panel panel-{if $reply.admin}success{else}info{/if}">
    ...
    <div class="panel-body">
     {if $reply.admin}
<img src="https://i.imgur.com/tNVTMFa.jpg" align="right">
{elseif $reply.userid}
<img src="https://www.gravatar.com/avatar/{$email|md5}?s=60&default=mm" title="Você pode alterar essa imagem acessando sua conta do Gravatar.com" align="right">
{/if} {$reply.message}
